        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="mt-4 text-slate-300 leading-relaxed">
              I’m Mohamed Higazy, a CX/UX designer focused on crafting human-centered products. My toolkit spans discovery research, journey mapping, prototyping, and design systems. I love collaborating with engineering and product to turn insights into simple, elegant experiences.
            </p>
